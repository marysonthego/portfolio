    ...
    return (
      <>
        <p className="blogText"> <br/>
          <b>This is the first </b>in a series of occasional posts I plan to write about ideas I want to try. Since most of my ideas tend to involve things I don't know how to do, I'm hopeful that writing about the <i>journey of discovery </i>will inspire someone else to pursue their own!
        </p>
        <p className="blogText">
          ...
          <p className="blogText">
            When I started working on the <a href="/b221121" >SQL Joins</a> series, it quickly became apparent to me that I needed an interactive database connection<b><i> right on the page</i></b>. I wanted a place where you could enter queries and get live results. Screen-shots wouldn't cut it. I wanted a place where people could experiment, make mistakes, experiment again, and repeat as many times as they wanted.
          </p>
          ...
          <p className="blogText">
            ...
            <p className="blogText">
            <b>I really like </b>the open-source <i>collabenation</i>  (<i>collaborative implementation</i>, get it?) between <a href="https://supabase.com/blog/postgres-wasm" target="_blank" rel="noreferrer">Supabase and Snaplet</a>. In their implementation, Wasm embeds Linux running a Postgres server at near-native  speed. Here's what their no-frills interface <a href="https://postgres-wasm.netlify.app/" target="_blank" rel="noreferrer">looks like</a>.
          </p>
          <h2 className="blog">Quick and Dirty Implementation</h2>
            <p className="blogText">
            My interface isn't beautiful (it's just a black and white xTerm running PSQL in a web page); but thanks to <a href="https://supabase.com/blog/postgres-wasm" target="_blank" rel="noreferrer">Supabase and Snaplet</a>, it's <b>reliable and instant-on.</b> Since it's pre-compiled, there's no waiting for initialization. You can type in SQL queries, see the results, even delete tables if you want to; but as soon as you refresh the browser, everything is restored to its initial state very quickly. It's a great simple-to-implement learning tool!
          </p>
