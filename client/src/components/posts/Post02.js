...
export const Post02 = () => {
  ...
  let Section1 = (
    <div>
      ...
      <img className="post-img-top" src={"media/post0204.png"} alt="Post " />
      <p className="ptext"><br/>
        First, let's import the React components we will need (createRef, forwardRef, and useState).
        </p>
        <img className="post-img-top" src={"media/post0201.png"} alt="Post " />
        <p className="ptext"> <br/>
        ...
        <img className="post-img-top" src={"media/post0203.png"} alt="Post " />
      <p className="ptext"> <br/>
      ...
      <img className="post-img-top" src={"media/post0207.png"} alt="Post " />
      <p className="ptext"><br/>
      ...
      <img className="post-img-top" src={"media/post0208.png"} alt="Post " />
      <p className="ptext"><br/>
