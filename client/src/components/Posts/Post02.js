...
export const Post02 = () => {
  ...
  let Section1 = (
    <div>
      ...
      <img className="card-img-top" src={"media/post0204.png"} alt="Card image" />
      <p className="card-text"><br/>
        First, let's import the React components we will need (createRef, forwardRef, and useState).
        </p>
        <img className="card-img-top" src={"media/post0201.png"} alt="Card image" />
        <p className="card-text"> <br/>
        ...
        <img className="card-img-top" src={"media/post0203.png"} alt="Card image" />
      <p className="card-text"> <br/>
      ...
      <img className="card-img-top" src={"media/post0207.png"} alt="Card image" />
      <p className="card-text"><br/>
      ...
      <img className="card-img-top" src={"media/post0208.png"} alt="Card image" />
      <p className="card-text"><br/>
